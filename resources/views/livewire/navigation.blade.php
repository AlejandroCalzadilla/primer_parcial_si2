      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              ...
              <a href="{{route('producto')}}" class="text-white hover:bg-gray-100 hover:text-gray-900 rounded-md px-3 py-2 text-sm font-medium">productos</a>
       ...
       @auth
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <!-- Profile dropdown  o menu perfil-->
          ...
          @else
           <div>
            <a href="{{route('login')}}" class="text-white hover:bg-gray-100 hover:text-gray-900 rounded-md px-3 py-2 text-sm font-medium">login</a>
              <a href="{{route('register')}}" class="text-white hover:bg-gray-100 hover:text-gray-900 rounded-md px-3 py-2 text-sm font-medium">register</a>
           </div>
